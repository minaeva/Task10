...
INSERT INTO lessons (group_id, teacher_id, subject_id, auditorium_id, start_date_time) VALUES
    ...
    (1, 4, 2, 4, '2019-04-15 14:00:00+2'),

    (1, 2, 1, 5, '2019-04-16 08:30:00+2'),
    (1, 4, 2, 5, '2019-04-16 10:20:00+2'),
    (1, 1, 1, 5, '2019-04-16 12:20:00+2'),
    (1, 3, 2, 5, '2019-04-16 14:00:00+2'),

    (1, 3, 2, 4, '2019-04-17 08:30:00+2'),
    (1, 1, 1, 4, '2019-04-17 10:20:00+2'),
    (1, 1, 1, 4, '2019-04-17 12:20:00+2'),
    (1, 1, 1, 4, '2019-04-17 14:00:00+2'),

    (1, 4, 2, 3, '2019-04-18 08:30:00+2'),
    (1, 3, 1, 3, '2019-04-18 10:20:00+2'),
    (1, 2, 1, 3, '2019-04-18 12:20:00+2'),
    (1, 2, 1, 3, '2019-04-18 14:00:00+2'),
    ...
    (2, 6, 3, 7, '2019-04-15 10:20:00+2'),
    (2, 5, 3, 8, '2019-04-15 12:20:00+2'),

    (2, 6, 3, 9, '2019-04-16 14:00:00+2'),
    (2, 5, 3, 9, '2019-04-16 15:40:00+2'),
    (2, 6, 3, 6, '2019-04-16 08:30:00+2'),

    (2, 5, 3, 7, '2019-04-17 10:20:00+2'),
    (2, 7, 4, 8, '2019-04-17 12:20:00+2'),

    (2, 8, 4, 9, '2019-04-18 14:00:00+2'),
    (2, 7, 4, 9, '2019-04-19 15:40:00+2');
